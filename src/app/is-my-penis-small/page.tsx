    ...
    <article className="space-y-10">
      <section className="space-y-5 rounded-2xl border border-slate-200 bg-gradient-to-b from-white to-slate-50 p-6 sm:p-8">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <Link href="/penis-size-calculator" className="rounded-md bg-brand-700 px-5 py-3 text-center font-semibold text-white hover:bg-brand-800">Use the Penis Size Calculator</Link>
      ...
      <section className="rounded-2xl border border-brand-200 bg-brand-50 p-6 text-center space-y-3"><h2 className="text-2xl font-semibold text-slate-900">Compare privately with average data</h2><p className="text-slate-700">If you want a clearer answer, measure correctly and use the private calculator. Your measurement is calculated in your browser and is not stored.</p><div className="flex flex-col gap-3 sm:flex-row sm:justify-center"><Link href="/penis-size-calculator" className="rounded-md bg-brand-700 px-5 py-3 text-center font-semibold text-white hover:bg-brand-800">Use the Penis Size Calculator</Link><Link href="/penis-size-percentile-calculator" className="rounded-md border border-brand-300 bg-white px-5 py-3 text-center font-semibold text-brand-800 hover:bg-brand-100">Try Percentile Calculator</Link></div></section>
